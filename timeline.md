    ...
    <div class="container">
      <div class="row text-center">
        ...
        <h4><a href="/">←<small style="font-size:14px;">Visual Resumé </small></a>Timeline Resumé <a href="/classic.html"><small style="font-size:14px;">Classic Resumé</small>→</a></h4>
          <a href="https://opus.stedden.org/2015/01/a-better-linkedin/"><span class="mytooltip" tlite="se" title="<p style=&quot;margin-bottom:0;font-size:1.2em;text-align:center&quot;>Displays connections between people I've worked with, <br/> projects I've worked on, and skills required for each project.<br/> Width is scale of project, height is time occupied. <br/> You can click on a project for more details. </p>" >🛈</span></a>
        </div>
      </div>
    </div>
